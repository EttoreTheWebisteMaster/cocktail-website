...
export default function Menu() {
    ...
    useGSAP(() => {
        ...
        gsap.fromTo('.cocktail img', { opacity: 0, xPercent: -100 }, { opacity: 1, duration: 1, xPercent: 0 });
            ...
            <div className="content">
                <div className="arrows">
                    <button className="text-left" onClick={() => {goToSlide(currentIndex - 1)}}>
                        ...
                        <img src="/images/right-arrow.png" alt="right" aria-hidden="true" />
                    </button>
                    <button className="text-left" onClick={() => {goToSlide(currentIndex + 1)}}>
                        <span>{nextCocktail.name}</span>
                        <img src="/images/left-arrow.png" alt="left" aria-hidden="true" />
                    </button>
                </div>
